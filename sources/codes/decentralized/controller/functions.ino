void build_automata(){
  ...
  Serial.println("S1");
  S1.addTransition(&S1_0, &S1_0, init, NULL); 
  S1.addTransition(&S1_0, &S1_1, open_vin, NULL);
  S1.addTransition(&S1_1, &S1_0, level_H1, NULL);
  S1.addTransition(&S1_1, &S1_0, reset, NULL);
  S1.addTransition(&S1_0, &S1_0, reset, NULL);

  Serial.println("S2");
  S3.addTransition(&S2_0, &S2_0, init, NULL); 
  S3.addTransition(&S2_0, &S2_1, open_vout, NULL);
  S3.addTransition(&S2_1, &S2_0, level_L1, NULL);
  S3.addTransition(&S2_1, &S2_0, reset, NULL);
  S3.addTransition(&S2_0, &S2_0, reset, NULL);
  
  Serial.println("S3");
  S3.addTransition(&S3_0, &S3_0, init, NULL); 
  S3.addTransition(&S3_0, &S3_1, process_start, NULL); 
  S3.addTransition(&S3_1, &S3_0, open_vin, NULL); 
  S3.addTransition(&S3_1, &S3_2, finish, NULL); 
  S3.addTransition(&S3_2, &S3_0, open_vin, NULL); 
  S3.addTransition(&S3_1, &S3_0, reset, NULL); 
  S3.addTransition(&S3_2, &S3_0, reset, NULL); 
  S3.addTransition(&S3_0, &S3_0, reset, NULL); 
  
  Serial.println("S4");
  S4.addTransition(&S4_0, &S4_0, init, NULL); 
  S4.addTransition(&S4_0, &S4_1, cooled, NULL); 
  S4.addTransition(&S4_1, &S4_0, open_vout, NULL); 
  S4.addTransition(&S4_1, &S4_2, turn_off_tcontrol, NULL); 
  S4.addTransition(&S4_2, &S4_1, turn_on_tcontrol, NULL); 
  S4.addTransition(&S4_2, &S4_0, open_vout, NULL); 
  ...
  S5.addTransition(&S5_0, &S5_1, level_H1, NULL); 
  S5.addTransition(&S5_1, &S5_2, turn_on_mixer, NULL); 
  S5.addTransition(&S5_2, &S5_0, turn_off_mixer, NULL); 
  S5.addTransition(&S5_2, &S5_1, level_H1, NULL); 
  ...
  S6.addTransition(&S6_0, &S6_1, cooled, NULL); 
  S6.addTransition(&S6_1, &S6_0, turn_off_mixer, NULL);
  S6.addTransition(&S6_2, &S6_0, turn_off_mixer, NULL);
  S6.addTransition(&S6_1, &S6_2, turn_off_tcontrol, NULL);
  S6.addTransition(&S6_2, &S6_1, turn_on_tcontrol, NULL);
  ...
  S7.addTransition(&S7_0, &S7_1, heated, NULL); 
  S7.addTransition(&S7_1, &S7_2, turn_on_pump, NULL); 
  S7.addTransition(&S7_2, &S7_1, heated, NULL); 
  S7.addTransition(&S7_2, &S7_0, turn_off_pump, NULL); 
  ...
  S8.addTransition(&S8_0, &S8_1, cooled, NULL); 
  S8.addTransition(&S8_1, &S8_0, turn_off_pump, NULL); 
  S8.addTransition(&S8_0, &S8_2, turn_on_pump, NULL); 
  S8.addTransition(&S8_2, &S8_1, cooled, NULL); 
  ...
  S9.addTransition(&S9_0, &S9_1, level_H1, NULL); 
  S9.addTransition(&S9_1, &S9_0, turn_on_tcontrol, NULL);
  S9.addTransition(&S9_1, &S9_2, close_vin, NULL);
  S9.addTransition(&S9_2, &S9_1, open_vin, NULL);
  S9.addTransition(&S9_2, &S9_0, turn_on_tcontrol, NULL);
  ...
  S10.addTransition(&S10_0, &S10_1, turn_on_tcontrol, NULL); 
  S10.addTransition(&S10_1, &S10_2, heated, NULL); 
  S10.addTransition(&S10_2, &S10_0, cooled, NULL);
