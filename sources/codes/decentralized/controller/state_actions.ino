...
void S1_1_action(){
    S1.disable(close_vin);       
}

void S2_0_action(){
    S2.enable(close_vout);    
}

void S2_1_action(){
    S2.disable(close_vout);    
}
...
void S5_0_action(){
  S5.disable(turn_on_mixer);  
}

void S5_1_action(){
  S5.enable(turn_on_mixer);  
}
...
void S8_1_action(){
  S8.enable(turn_off_pump);
}

void S8_2_action(){
  S8.disable(turn_off_pump);
}

void S9_0_action(){
  S9.disable(turn_on_tcontrol);
}

void S9_1_action(){
  S9.enable(turn_on_tcontrol);
}
...
void S10_0_action(){
  S10.enable(turn_off_tcontrol);
}

void S10_1_action(){
  S10.disable(turn_off_tcontrol);
}
